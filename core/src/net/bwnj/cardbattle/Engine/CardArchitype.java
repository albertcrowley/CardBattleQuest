...
public class CardArchitype {
    ...
    public static float card_frame_widht = 969F;
    public static float card_frame_height = 1352F;
    public static float card_ratio = card_frame_widht / card_frame_height;
    public static float card_art_x = 82F/card_frame_height;
    public static float card_art_y = 602F/ card_frame_height;
    public static float card_art_width = (890-82) / card_frame_height;
    public static float card_art_height = (1196-602) / card_frame_height;
    public static float card_text_x = 200F/card_frame_height;
    public static float card_text_y = 425F/card_frame_height;
    public static float card_name_x = .07F ;
    public static float card_name_y = .935F ;
